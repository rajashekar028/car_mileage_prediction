...
with open('C:/Users/RajaShekar/OneDrive/Desktop/car_mpg_deploying/model.pkl', 'rb') as file:
...
def predict():
    ...
    return render_template('index.html', prediction_text='MPG for the car is {}'.format(output))
